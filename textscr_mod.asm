...
ScrollText	    		db	"MetaProducts Offline Explorer Enterprise 8.3.4936 [SR1] - *kEyGeN.iNc.PaTcH* :: "
						db  "protection : RSA-790 :: algo and"
						db  " gfx by r0ger :: msx by leopart :: scrollerbox by LP^REV ...                                                           "
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,5
		mov scr.scroll_y,224
		
		mov scr.scroll_width,438
